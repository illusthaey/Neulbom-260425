...
window.NEULBOM_SITE_CONFIG = {
  site: {
    name: "업무천재 고주무관의 늘봄학교 행정 실무 가이드",
    shortName: "고",
  ...
  pages: {
    home: {
      ...
      hero: {
        ...
        titleHtml: "늘봄 업무,<br />담당자 스스로 공부합시다.",
        lead: "본인 업무는 스스로 업무 자료 찾아보고 공부하고 연구해서 행정실 검토 없이 혼자 힘으로 처리할 수 있도록 합시다.",
    ...
    "study-method-example": {
      browserTitle: "막힌 업무 방법 탐색 예시 | 늘봄학교 행정 실무 가이드",
      footerLabel: "막힌 업무 해결 방법 탐색 예시 - 서식 변경 요청",
      hero: {
        breadcrumb: "자기주도적 업무 해결 방법 / 서식 변경 요청 시 /",
        kicker: "예시 01 · 서식 변경 요청이 들어왔을 때",
        title: "행정실에서 징수 요구 엑셀 서식을 변경해달라고 했을 때",
        lead: "서식을 어떻게 고쳐야할지 모르겠으면, 행정실 주무관이 문서등록대장에서 이전에 업무 처리한 내역을 찾아봅시다."
      }
    },
